function About() {
    return (
      ...
      >
        ...
        <div className="flex flex-col pt-8 gap-y-30  pb-0 mb-40 mt-32 border-t-[1px] pt-[1vw] border-[#a1b562]">
    <div className="flex flex-row md:flex-row gap-x-10 lg:gap-x-20">
      ...
      <div >
        <div className="wysiwyg w-600 h-600 align-center justify-center">
          ...
          is unmatched; we employ innovative, industry-leading protocols and
