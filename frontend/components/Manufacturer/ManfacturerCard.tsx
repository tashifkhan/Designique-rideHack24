		...
		<>
			...
			<ChatModal
				designer={{
					...
					coverImage: manufacturer.coverImage,
					specialization: manufacturer.specialization,
					bio: `${manufacturer.name} is a specialized manufacturer in ${manufacturer.specialization} with a minimum order quantity of ${manufacturer.minOrderQuantity} and production capacity of ${manufacturer.productionCapacity}.`,
					collections: 0,
					followers: 0,
					following: 0,
				}}
