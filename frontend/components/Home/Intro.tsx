...
export function BackgroundLinesDemo() {
  return (
    <BackgroundLines
      className="flex items-center justify-center w-full h-screen flex-col px-4"
      style={{
        background: "radial-gradient(circle at top left, rgba(128, 0, 128, 0.8) 30%, black 80%)",
        backgroundSize: 'cover', // Ensure the gradient covers the full area
      }}
    >
